...
joblib.dump(best_gb, "/nfs-data/ULMS/Diane/model_revised/GB_deg"+str(num_of_gene)+"/GAPDH_scale_remove_race_diff_zero_sum_norm_mse_GB.h5")
best_gb_hp_df.to_csv('/nfs-data/ULMS/Diane/model_revised/GB_deg'+str(num_of_gene)+'/best_gb_hp.csv', index=False)
...
# # %%
# best_gb = joblib.load("/home/srkim/ULMS/sample_mean_0_normalize/model/kt_bayesian_norm_MSE/GB/GAPDH_scale_remove_race_diff_zero_sum_norm_mse_GB.h5")
