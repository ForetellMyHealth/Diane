...
joblib.dump(best_svm, "/nfs-data/ULMS/Diane/model_revised/SVM_deg"+str(num_of_gene)+"/GAPDH_scale_remove_race_diff_zero_sum_norm_mse_SVM.h5")
best_svm_hp_df.to_csv('/nfs-data/ULMS/Diane/model_revised/SVM_deg'+str(num_of_gene)+'/best_svm_hp.csv', index=False)
...
# %%
# best_svm = joblib.load("/home/srkim/ULMS/sample_mean_0_normalize/model/kt_bayesian_norm_MSE/SVM/GAPDH_scale_remove_race_diff_zero_sum_norm_mse_SVM.h5")
